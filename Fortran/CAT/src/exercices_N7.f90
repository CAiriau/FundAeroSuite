...
real(kind=8)        :: Me,omega,section_ratio,Rcrit,Mcol,Scol,Pexit,Sexit
...
write(6,*)'Pi_O                    =',Pi0
section_ratio= A_Acritic(Me)
write(6,*)'Se/Scrit                =',section_ratio
Scol=val_pi*Rcol**2
Sexit=Scol*section_ratio
Rexit=Rcol*sqrt(section_ratio)
write(6,*)'Se                      =',Sexit
write(6,*)'Re                      =',Rexit
...
write(6,*)'Mach exit après le choc = ', Mach_downstr(Me)
...
P(k)            = P0
theta(k)        = 0.d0
upstr_zone(k)   = 0             ! si elle même, pas de correction d'incidence
longueur(k)     = 1.d0
profil(k)       = 1
! zone 1 :  choc oblique
k=1
...
call aerodynamic_coefficients  ! calcul des coefficients aérodynamiques
