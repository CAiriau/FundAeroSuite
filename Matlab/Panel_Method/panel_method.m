...
% Main script, choose the option
% 
% Args:
%   option : the option to select to test any case
%   alpha  : the angle of attack in degrees, optional

%%*******************************************************
%  Use : 
%   3 cases
%   * panel_method()       
%   * panel_method(n)              where  n is the option (< 16)
%   * panel_method(n,alpha)        where  alpha is the AoA in degrees
